        ...
        try:
            ...
            if ("metaData" in json):
                if ("notePublic" in json):
                    randomLink = my_random_string(15)
                    note = Notes(idUser=param, type=json['type'], title=json['title'], pinned=json['pinned'], dueAt=date_dueAt,
                             remindAt=date_rmAt, lock=lockPass, r=color['r'], g=color['g'], b=color['b'], a=color['a'], metaData=json['metaData'], notePublic = json['notePublic'], randomLink = json['linkNoteShare'] )
                else:
                    note = Notes(idUser=param, type=json['type'], title=json['title'], pinned=json['pinned'], dueAt=date_dueAt,
                ...
                if ("notePublic" in json):
                    randomLink = my_random_string(15)
                    note = Notes(idUser=param, type=json['type'], title=json['title'], pinned=json['pinned'], dueAt=date_dueAt,
                             remindAt=date_rmAt, lock=lockPass, r=color['r'], g=color['g'], b=color['b'], a=color['a'], notePublic = json['notePublic'] , randomLink = json['linkNoteShare'] )
                else:
                    note = Notes(idUser=param, type=json['type'], title=json['title'], pinned=json['pinned'], dueAt=date_dueAt,
        ...
        try:
            ...
            for key in list(json.keys()):
                ...
                if (key == 'notePublic'):
                    ...
                    randomLink = my_random_string(15)
                    note_query.linkNoteShare = randomLink
                if (key == 'remindAt'):
                    date_rmAt = None
                    if (json['remindAt']):
                        date_rmAt = datetime.strptime(
